...
Pod::Spec.new do |s|
  ...
  s.source_files = 'CommonSetting/Classes/**/*'
  
  s.subspec 'Core' do |ss|
      ss.source_files = 'CommonSetting/Classes/Core/*'
    end
  
  s.subspec 'About' do |ss|
      ss.source_files = 'CommonSetting/Classes/About/*'
      ss.dependency 'CommonSetting/Core'
    end
  
  s.subspec 'Introduce' do |ss|
      ss.source_files = 'CommonSetting/Classes/Introduce/*'
      ss.dependency 'CommonSetting/Core'
    end
